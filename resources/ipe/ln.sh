#!/bin/bash
# Symbolic link to IPE styles directory
ln -sf "${PWD}/ColorPalette.black.isy" "${HOME}/.ipe/styles/ColorPalette.black.isy"
ln -sf "${PWD}/ColorPalette.gray.isy" "${HOME}/.ipe/styles/ColorPalette.gray.isy"
ln -sf "${PWD}/ColorPalette.seasonal.isy" "${HOME}/.ipe/styles/ColorPalette.seasonal.isy"
ln -sf "${PWD}/ColorPalette.coolors.isy" "${HOME}/.ipe/styles/ColorPalette.coolors.isy"
